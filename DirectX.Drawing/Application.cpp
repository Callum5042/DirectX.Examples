...
bool Application::OnInitialise()
{
	...
	bd.CPUAccessFlags = 0;
	hr = m_Device->CreateBuffer(&bd, nullptr, &g_pConstantBuffer1);
	if (FAILED(hr))
	{
...
void Application::OnRender()
{
	...
	m_DeviceContext->VSSetConstantBuffers(0, 1, &g_pConstantBuffer1);
	m_DeviceContext->PSSetConstantBuffers(0, 1, &g_pConstantBuffer1);

	m_DeviceContext->UpdateSubresource(g_pConstantBuffer1, 0, nullptr, &cb, 0, 0);
